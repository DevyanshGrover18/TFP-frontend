...
import BadgesModal from "@/components/admin/products/BadgesModal";
import DeleteModal from "@/components/common/DeleteModal";
import ProductModal from


"@/components/admin/products/ProductModal";
import {
  createBadge,
  deleteBadge as deleteBadgeRecord,
  getAllBadges } from

"@/services/badgesService";
...
export default function ProductsPage() {
  ...
  const handleCreateBadge = async (name) => {
