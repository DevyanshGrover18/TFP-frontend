...
import SpecialUserModal from

"@/components/admin/special-users/SpecialUserModal";
import DeleteModal from "@/components/common/DeleteModal";
import {
  getAllSpecialUserRequests,
  updateSpecialUserRequestStatus,
  deleteSpecialUserRequest } from

"@/services/specialUserService";
import {
  createSpecialUser,
  getAllSpecialUsers } from
"@/services/specialUserService";
...
export default function SpecialUserRequestsPage() {
  ...
  const handleCreateSpecialUser = async (values) => {
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="flex items-center gap-2 rounded-2xl border border-gray-200 bg-white px-4 py-2 shadow-sm">
        ...
        {["all", "pending", "approved", "declined"].map((val) =>
        <button
          key={val}
