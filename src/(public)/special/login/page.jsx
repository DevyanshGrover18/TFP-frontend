...
import { createSpecialUserRequest } from "@/services/specialUserService";
...
const emptyRequest = { name: "", company: "", email: "" };
    ...
    <div
      ...
      <div className="w-full max-w-md overflow-hidden rounded-3xl bg-white shadow-2xl" style={{ border: "1px solid #f0e0dc" }}>
        ...
        <div className="space-y-4 px-8 py-6">
          ...
          { field: "company", label: "Company Name", placeholder: "Your company", type: "text" },
          { field: "email", label: "Business Email", placeholder: "you@company.com", type: "email" }].
...
export default function SpecialUserLoginPage() {
  ...
  const [values, setValues] = useState(emptyLogin);
  ...
  const handleRequestSubmit = async (reqValues) => {
    try {
