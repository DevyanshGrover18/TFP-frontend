...
import { createOrder, sendOrderSuccessMail } from "@/services/orderService";
import {
...
export default function RegistrationForm() {
  ...
  const validateStep = (currentStep) => {
    ...
    if (currentStep === 2) {
      ...
      if (!form.details.email.trim()) nextErrors.email = "Email is required";else
      if (!/\S+@\S+\.\S+/.test(form.details.email)) {
