...
const Footer = () => {
  ...
  return (
    <footer
      ...
      style={{ backgroundColor: "#fdf5f3", borderTop: "1px solid #f0e0dc", fontFamily: "'DM Sans', sans-serif" }}
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-10 lg:grid-cols-4">
          ...
          <div className="col-span-2 flex flex-col gap-4 lg:col-span-1">
            <img src="/logo-black.png" alt="The Fabric People" className="h-auto w-30" />
            <p className="text-xs leading-relaxed text-gray-500 max-w-[200px]">
              Providing sourcing solutions for Innerwear | Swimwear | Activewear | Nightwear | Loungewear
            </p>
          </div>
          ...
          {/* Contact Us */}
          <div className="col-span-2 flex flex-col gap-4 lg:col-span-1">
            <h4 className="text-sm font-semibold" style={{ color: "#1a1a1a" }}>Contact Us</h4>
            <div className="flex flex-col gap-3 text-xs text-gray-600 leading-relaxed">
              <p>
                <span className="font-semibold" style={{ color: "#d94f4f" }}>Head Office : </span>
                477B, 1st Floor, Ram Bazar, Cloth Market, Fatehpuri, Delhi - 110006, India
              </p>
              <p>
                <span className="font-semibold" style={{ color: "#d94f4f" }}>Works : </span>
                G-3B, Ground Floor, Sector D1(P3), Tronica City, Loni, Ghaziabad, UP - 201102, India
              </p>
              <div className="flex flex-col gap-2 mt-1">
                <a href="tel:+918811071145" className="flex items-center gap-2 hover:text-gray-900 transition-colors">
                  <Phone size={12} style={{ color: "#d94f4f" }} />
                  +91-8811071145
                </a>
                <a href="mailto:thefabricpeople@gmail.com" className="flex items-center gap-2 hover:text-gray-900 transition-colors">
                  <Mail size={12} style={{ color: "#d94f4f" }} />
                  thefabricpeople@gmail.com
                </a>
                <a href="https://www.thefabricpeople.in" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-gray-900 transition-colors">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            {[
              { label: "LinkedIn", href: "#", svg: <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z M2 9h4v12H2z M4 6a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" /> },
              ...
              { label: "Website", href: "https://www.thefabricpeople.in", svg: <><circle cx="12" cy="12" r="10"/><line x1="2" x2="22" y1="12" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></> },
            ].map(({ label, href, svg }) => (
              <a
                key={label}
                href={href}
