...
export default function SpecialUserLoginModal({
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-3xl overflow-hidden rounded-3xl bg-white shadow-2xl" style={{ border: "1px solid #f0e0dc" }}>

        {/* Left panel — hidden on mobile */}
        <div
          className="relative hidden w-64 shrink-0 flex-col justify-between p-8 sm:flex"
          style={{ background: "linear-gradient(160deg, #E8654A 0%, #E8426A 100%)" }}
        >
          {/* Decorative circles */}
          ...
          <div className="relative">
            <div className="mb-6 inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-white/20">
          ...
          <div className="relative space-y-4">
            {[
              ...
              <div key={item.label} className="flex items-start gap-3">
                <div className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-white/70" />
                <div>
        ...
        <div className="flex flex-1 flex-col">
          ...
          {/* Header */}
          <div className="flex items-start justify-between border-b border-[#f0e0dc] px-6 py-5 sm:px-8">
            <div>
              <p className="mb-1 text-[10px] font-semibold uppercase tracking-[0.24em] text-[#d94f4f] sm:hidden">
                B2B Portal
              </p>
              <h3
                className="text-2xl italic text-[#1a1a1a]"
            ...
            <button
              type="button"
              onClick={onClose}
              className="ml-4 shrink-0 rounded-xl p-1.5 text-[#bbb] transition-colors hover:bg-[#fdf5f3] hover:text-[#d94f4f]"
              aria-label="Close"
            >
          ...
          <div className="flex-1 space-y-4 px-6 py-6 sm:px-8">
            ...
            <div className="space-y-1.5">
              <label className="block text-[10px] font-semibold uppercase tracking-[0.22em] text-[#d94f4f]">
                Email
              </label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-[#ccc] transition-colors hover:text-[#d94f4f]"
                  tabIndex={-1}
          ...
          {/* Footer */}
          <div className="flex items-center justify-between border-t border-[#f0e0dc] px-6 py-5 sm:px-8">
            <button
              type="button"
              onClick={onClose}
              disabled={isLoading}
              className="rounded-xl border border-[#f0e0dc] px-4 py-2.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#888] transition-colors hover:border-[#E8654A] hover:text-[#d94f4f] disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              ...
              disabled={isLoading}
              className="flex items-center gap-2 rounded-xl px-6 py-2.5 text-[11px] font-bold uppercase tracking-[0.16em] text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-70"
