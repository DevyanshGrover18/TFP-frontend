...
const STATUS_ORDER: OrderRecord["status"][] = [
  "Pending",
  "Processing",
  "Completed",
];
      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="grid gap-8 lg:grid-cols-[3fr_2fr]">
          ...
          <section className="space-y-6">
            {/* Timeline card — replace the existing one */}
                ...
                <div className="mt-8 flex items-start gap-4 rounded-2xl border border-red-100 bg-red-50 p-5">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-red-600">
                      This quote request has been cancelled. Please reach out if
                      you believe this is an error or to resubmit.
                    </p>
                  </div>
                </div>
              ) : (
                      ...
                      return (
                        <div key={step.key} className="flex gap-5">
                          ...
                          <div className={`${isLast ? "pb-0" : "pb-8"}`}>
                            ...
                            {/* Fields — shown under the active step only */}
                            {state === "active" &&
                              order.fields &&
                              order.fields.length > 0 && (
                                <div className="mt-4 overflow-hidden rounded-2xl border border-[#ece7de] bg-[#fafaf5]">
                                  <div className="border-b border-[#ece7de] px-4 py-2.5">
                                    <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[#7a736c]">
                                      Reference details
                                    </p>
                                  </div>
                                  <div className="divide-y divide-[#ece7de]">
                                    {order.fields.map((field) => (
                                      ...
                                      >
                                        <p className="text-xs font-medium capitalize text-[#7a736c]">
                                          {field.key.replace(/_/g, " ")}
                                        </p>
                                        <p className="ml-4 text-right text-xs font-semibold text-[#01010f]">
                                          {field.value || "—"}
                                        </p>
                                      </div>
                                    ))}
            ...
            <div className="rounded-3xl bg-white p-8 shadow-[0_20px_40px_rgba(26,28,25,0.06)]">
              ...
              >
                {order.items.length}{" "}
                {order.items.length === 1 ? "fabric" : "fabrics"}
              </h2>
                ...
                {order.items.map((item) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="truncate font-medium text-[#01010f]">
                        {item.name}
                      </p>
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-3xl bg-white p-6 shadow-[0_20px_40px_rgba(26,28,25,0.06)]">
              ...
              <div className="mt-4 space-y-5">
                ...
                <AddressSummary
                  ...
                  sameLabel={
                    shipping.sameAsInvoice ? "Same as invoice" : undefined
                  }
                  lines={
            ...
            <div className="rounded-3xl border border-dashed border-[#ddd6cc] p-6">
              ...
              <p className="mt-2 text-sm leading-6 text-[#6b6a70]">
                Questions about your quote? Reach out and we'll get back to you
...
function StepDot({
  ...
  if (state === "active") {
    return (
      <div
        className={`${base} bg-[#01010f] text-white ring-4 ring-[#01010f]/10`}
      >
        {icon}
      </div>
    );
  ...
  return (
    <div
      className={`${base} border-2 border-[#e5e0d8] bg-white text-[#c8c0b6]`}
    >
      {icon}
    </div>
  );
