...
export default function AccountPage() {
  ...
  const setShipping = (field: keyof UserQuoteProfile["shipping"], value: string | boolean) =>
    setProfile((c) => ({ ...c, shipping: { ...c.shipping, [field]: value } }));

  const setDetails = (field: keyof UserQuoteProfile["details"], value: string | boolean) =>
